...
import com.android.launcher3.uioverrides.FeedBridge;
...
public class LauncherClient {
    ...
    private static void loadApiVersion(Context context) {
        ResolveInfo resolveService = context.getPackageManager().resolveService(FeedBridge.overlayIntent(context), PackageManager.GET_META_DATA);
